...
function FeaturedPlayer({ videoId }: { videoId: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#e8c97e] via-purple-400 to-pink-400 rounded-3xl opacity-30 group-hover:opacity-50 blur transition-opacity duration-500" />
      ...
      <div className="absolute inset-0 z-30 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-0 left-0 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-[#e8c97e] to-transparent"
        />
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="absolute bottom-4 left-4 flex items-center gap-2 px-3 py-1.5 rounded-full backdrop-blur-md cursor-pointer z-40"
          style={{ 
            background: "rgba(0,0,0,0.8)", 
        ...
        {/* Duration badge */}
        <div className="absolute bottom-4 right-4 px-2 py-1 rounded-md backdrop-blur-md text-xs font-mono z-40"
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -inset-1 bg-gradient-to-r from-[#e8c97e] to-amber-500 rounded-2xl blur-xl"
      />
      
      {/* Card content */}
      <div className="relative bg-gray-900 rounded-2xl overflow-hidden shadow-xl border border-white/10">
        {/* Thumbnail */}
        <div className="relative w-full overflow-hidden" style={{ aspectRatio: "16/9" }}>
          ...
          {isActive && (
            <motion.div
              ...
              className="absolute top-2 left-2 w-2 h-2 rounded-full bg-[#e8c97e]"
          ...
          >
            <div className="w-10 h-10 rounded-full bg-[#e8c97e] flex items-center justify-center">
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-white/40">{video.views} views</span>
          </div>
          ...
          <p className="text-xs text-white/40">{video.guest}</p>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <motion.a
              ...
              rel="noopener noreferrer"
              whileHover={{ x: 5 }}
              className="group flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm hover:bg-white/20 transition-all"
            >
              <span className="text-sm font-medium text-white/80">View all episodes</span>
              <svg
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-between">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="px-3 py-1.5 rounded-full bg-[#e8c97e]/10 text-[#e8c97e] text-xs font-semibold border border-[#e8c97e]/30">
                    {current.tag}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <p className="text-white/50">with {current.guest}</p>
                </div>
              </motion.div>
            </AnimatePresence>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-white/50">{current.duration}</span>
            </div>
          </div>
        </motion.div>
        ...
        <div className="relative my-10">
          ...
          <div className="relative flex justify-center">
            <span className="px-4 bg-black text-sm text-white/40">
              More episodes
            </span>
          </div>
        </div>
        ...
        >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-white/20 transition-all"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-white/20 transition-all"
          >
            <svg className="w-5 h-5 text-white/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {VIDEOS.slice(0, 3).map((v, i) => (
                <div
                  key={i}
                  className="w-6 h-6 rounded-full border-2 border-black bg-gradient-to-r from-[#e8c97e] to-amber-500 flex items-center justify-center text-[10px] font-bold text-black"
                >
                  {v.guest[0]}
                </div>
              ))}
            </div>
            <span className="text-sm text-white/50">+{VIDEOS.length} episodes</span>
          </div>
          <div className="w-px h-4 bg-white/20" />
          <div className="flex items-center gap-1 text-sm text-white/50">
            <svg className="w-4 h-4 text-[#e8c97e]" fill="currentColor" viewBox="0 0 20 20">
